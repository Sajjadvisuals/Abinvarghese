  ...
  function navHTML(){
    ...
    return '<a class="nav__brand" href="index.html"><span>Abin Varghese</span><span>Content Creator / Video Editor / Videographer</span></a>'+
      '<div class="nav__actions">'+
        '<nav class="nav__menu">'+
          link('content-creation.html','Content Creation','content')+
          link('video-editing.html','Video Editing','editing')+
    ...
    return '<div class="navmenu__bg" data-mclose></div>'+
      '<div class="navmenu__panel">'+
        ...
        '<nav class="navmenu__links">'+
          biglink('content-creation.html','Content Creation','content','01',1)+
          biglink('video-editing.html','Video Editing','editing','02',1)+
